...
**Status: v2 in progress** (branch `v2`). The app itself, uploads, the job queue, video ingest and in-browser playback work. The analysis stages are being built in this order:

1. court and ball tracking;
2. shots;
3. training/match detection and scoring;
4. players;
5. multiple videos.
